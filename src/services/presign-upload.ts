...
export function createPresignUploadService(api = defaultApi) {
  return class PresignUploadService {
    static async initUpload(
      request: PresignInitRequest
    ): Promise<ApiResponse<PresignInitResponse>> {
...
export const PresignUploadService = createPresignUploadService()
